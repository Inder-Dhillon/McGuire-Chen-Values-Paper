...
Label(frame, text="Export To CSV", font=("Roboto", 15), bg="white", pady=5).grid(row=0,columnspan=5,column=0, sticky=W+E+N+S)
...
Radiobutton(frame, text="McGuire Values", variable=radio_switch_ex, value="m", bg="white").grid(row=1, column=1, columnspan=3)
Label(frame, text="From Atomic Number ", font=("Roboto", 12), bg="white", pady=5).grid(row=2,column=0, sticky=W+E+N+S)
from_an = Entry(frame, justify=CENTER, bg="#e4e8e8", borderwidth=0, font=("Roboto", 13))
from_an.grid(row=2, column=1, sticky=W+E+N+S)
Label(frame, text="   To", font=("Roboto", 12), bg="white", pady=5).grid(row=2,column=2, sticky=W+E+N+S)
to_an = Entry(frame, justify=CENTER, bg="#e4e8e8", borderwidth=0, font=("Roboto", 13))
...
Label(frame, text="\n\n\nQuick View", font=("Roboto", 15), bg="white", pady=5).grid(row=3,columnspan=5,column=0, sticky=W+E+N+S)
Label(frame, text="Enter Atomic Number:", font=("Roboto", 12), bg="white", pady=5).grid(row=4,columnspan=5,column=0, sticky=W+E+N+S)
