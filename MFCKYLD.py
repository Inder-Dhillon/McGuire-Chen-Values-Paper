...
Label(frame, text="Export To CSV", font=("Roboto", 16), bg="white", pady=5).grid(row=0,columnspan=5,column=0, sticky=W+E+N+S)
...
Label(frame, text="________________________________________________\n\nQuick View", font=("Roboto", 16), bg="white", pady=5).grid(row=3,columnspan=5,column=0, sticky=W+E+N+S)
